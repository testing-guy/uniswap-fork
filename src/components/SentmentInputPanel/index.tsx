...
import SentmentSearchModal from '../SearchModal/SentmentSearchModal'
...
interface SentmentInputPanelProps {
  value: string
...
export default function SentmentInputPanel({
  value,
  onUserInput,
  onMax,
  showMaxButton,
