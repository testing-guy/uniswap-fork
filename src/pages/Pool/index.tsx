...
import { useOptions } from 'pages/CreateOption/hooks/useOptions'
...
import { OptionDetails, PositionDetails } from 'types/position'
          ...
          <AutoColumn gap="lg" justify="center">
            <AutoColumn gap="lg" style={{ width: '100%' }}>
              ...
              <MainContentWrapper>
                ...
                ) : filteredOptions && closedPositions && filteredOptions.length > 0 ? (
                  <OptionList
