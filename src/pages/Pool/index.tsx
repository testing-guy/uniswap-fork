...
import OptionList from '../options/components/OptionList'
...
const MoreOptionsButton = styled(ButtonGray)`
  border-radius: 12px;
  flex: 1 1 auto;
  padding: 6px 8px;WrongNetworkCard
            ...
            <AutoColumn gap="lg" style={{ width: '100%' }}>
              <TitleRow padding={'0'}>
                ...
                <ButtonRow>
                  ...
                  <ResponsiveButtonPrimary data-cy="join-pool-button" id="join-pool-button" as={Link} to="/add/v2/ETH">
              ...
              <MainContentWrapper>
                {optionsLoading ? (
                ...
                ) : filteredOptions && closedOptions && filteredOptions.length > 0 ? (
                  <OptionList
                  ...
                  <ErrorContainer>
                    <ThemedText.DeprecatedBody color={theme.deprecated_text3} textAlign="center">
                      ...
                      <div>
                        <Trans>Your active options will appear here.</Trans>
                      </div>
                    </ThemedText.DeprecatedBody>
                    {!showConnectAWallet && closedOptions.length > 0 && (
                      <ButtonText
