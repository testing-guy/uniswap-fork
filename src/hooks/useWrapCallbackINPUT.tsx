...
export default function useWrapCallback(
  ...
  return useMemo(() => {
    if (!wethContract || !chainId || !inputCurrency) return NOT_APPLICABLE
    ...
    if (inputCurrency.isNative && weth.equals(inputCurrency)) {
      return {
...
Please file a bug detailing how this happened - https://github.com/Uniswap/interface/issues/new?labels=bug&template=bug-report.md&title=Invalid%20WETH%20contract`)
    ...
    } else if (weth.equals(inputCurrency)) {
      return {
  ...
  }, [wethContract, chainId, inputCurrency, inputAmount, balance, addTransaction])
}
