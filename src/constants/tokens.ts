...
export const USDC_GOERLI = new Token(
  ...
  '0xE821232a687df6D6080e115881f4756cfcdDda89',
  6,
  'USDC',
  'USD//C'
)
...
export const USDC_ARBITRUM_RINKEBY = new Token(
  ...
  '0x824c32B01d494b4D974bCa963976Ae8486c95DF8',
  6,
  'USDC',
  'USD//C'
)
...
export const WETH_GOERLI = new Token(
  SupportedChainId.GOERLI,
  '0xEFCAae996a6b6848802d172F542a7Ff09B1690Eb',
  18,
  'GWETH',
  'Wrapped GOERLI TEST Ether'
)
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [SupportedChainId.ARBITRUM_RINKEBY]: new Token(
    SupportedChainId.ARBITRUM_RINKEBY,
    '0x74924a1d959a7bc0F3E994d34cD352c27D97BdBC',
    18,
    'WETH',
    'Wrapped Ether'
  ),
